...
export const UPDATES: Update[] = [
  {
    ...
    time: "4:20 AM",
    type: "feature",
    title: "Templates complete — 320 total",
    description:
      "The final wave lands the gallery at 320 templates, with all 16 categories at exactly 20 each — 10 website categories plus 6 interactive SaaS product categories, every app wired up with real state and mock data.",
  },
  {
    id: 31,
    date: "June 14, 2026",
    ...
    description:
      "Templates wave 14 — 307 total now; more interactive SaaS apps (survey builder, churn analytics, AI research assistant, partner CRM, workflow automation, treasury) plus new website templates across every category.",
  },
  {
    id: 30,
    date: "June 14, 2026",
    ...
    title: "24 more templates",
    description:
      "Templates wave 13 — 283 total now; more interactive SaaS apps (deal detail, win/loss, timesheet, retro board, billing portal, financial reports, POS, executive dashboard, AI email) plus new website templates across every category.",
  },
  {
    id: 29,
    date: "June 14, 2026",
    ...
    title: "24 more templates",
    description:
      "Templates wave 12 — 259 total now; more interactive SaaS apps (booking, AI photo editor, A/B testing, social listening, call center, content calendar, loans) plus new website templates across every category, including an interactive pricing calculator.",
  },
  {
    id: 28,
    date: "June 14, 2026",
