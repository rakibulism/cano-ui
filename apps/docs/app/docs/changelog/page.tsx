...
const RELEASES: Release[] = [
  {
    ...
    tag: "Templates",
    changes: [
      "Templates wave 14 — 24 more templates (now 307 total): more interactive SaaS products including a survey builder, churn analytics, an AI research assistant, partner CRM, workflow automation, and a treasury dashboard.",
      "More websites too: UX / AI / e-commerce agencies, 3D-artist / fashion-designer / sound-designer portfolios, accounting / engineering / cybersecurity firms, art exhibition, wellness retreat, book launch, AI-assistant / VPN / habit-tracker landings, a lifetime deal, science blog, and a language course.",
    ],
  },
  {
    version: "0.1.26",
    ...
    tag: "Templates",
    changes: [
      "Templates wave 13 — 24 more templates (now 283 total): more interactive SaaS products including a deal detail view, win/loss analysis, a timesheet, retro board, billing portal, financial reports, a point-of-sale app, executive dashboard, and an AI email assistant.",
      "More websites too: investor update, product teaser, engineering & marketing blogs, certification program, kids summer camp, pet & toy stores, feature deep-dive, integration detail, influencer agency, animator portfolio, hospitality group, esports tournament, and a browser-extension landing.",
    ],
  },
  {
    version: "0.1.25",
